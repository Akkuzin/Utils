...
public class ReflectionUtilsTest {
  ...
  static class Direct extends ArrayList<String> {
  ...
  public void directTest() {
    assertEquals(
        String.class, ReflectionUtils.getGenericParameterClass(Direct.class, ArrayList.class, 0));
  }

  static class DirectSecondLevel extends ArrayList<ArrayList<String>> {
    private static final long serialVersionUID = 1L;
  }
  ...
  public void directSecondLevelTest() {
    assertEquals(
        ArrayList.class,
        ReflectionUtils.getGenericParameterClass(DirectSecondLevel.class, ArrayList.class, 0));
  }

  static class DirectComplicated extends HashMap<ArrayList<String>, ArrayList<Integer>> {
    private static final long serialVersionUID = 1L;
  }
  ...
  public void directComplicatedTest() {
    assertEquals(
        ArrayList.class,
        ReflectionUtils.getGenericParameterClass(DirectComplicated.class, HashMap.class, 0));
  }

  static class AA<T> {}

  static class BB extends AA<String> {}

  static class CC<T> extends BB {}

  static class DD extends CC<Object> {}
  ...
  public void testGetTypeClassA0() {
    assertNotEquals(String.class, ReflectionUtils.getGenericParameterClass(G.class, A.class, 1));
  }
  ...
  public void testSetterJava11() throws Exception {
    ...
    Function<String, PropertyDescriptor> property =
        name ->
  ...
  public void testPropertyNameFromGetter() {
    assertThat(ReflectionUtils.propertyNameFor(ResultDto::getName)).isEqualTo("name");
    assertThat(ReflectionUtils.propertyNameFor(ResultDto::setName)).isEqualTo("name");
    assertThat(ReflectionUtils.propertyNameFor(ResultDto::isCheck)).isEqualTo("check");
    assertThat(ReflectionUtils.propertyNameFor(ResultDto::setCheck)).isEqualTo("check");
  }
}
