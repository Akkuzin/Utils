...
public class StringFunc {
	...
	public static String concatWithDelim(String str1, String delimiter, String str2) {
		return asList(str1, str2).stream()
	...
	/**
	 * <p>
	 * Gets the substring after the last occurrence of a separator. The separator is not returned. If there is no
	 * separator found then whole string is returned.
	 * </p>
	 * <p>
